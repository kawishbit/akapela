...
| - | ------ | ------ | ---------- |
| 01 | [The Worker is gone: fix the glossary](issues/01-glossary-worker-is-gone.md) | ready-for-agent | — |
| 02 | [External tools behind one seam](issues/02-tool-paths-behind-one-seam.md) | ready-for-agent | — |
| 03 | [The `desktop/` package and a window over a running server](issues/03-desktop-package-and-window.md) | ready-for-agent | — |
| 04 | [Electron starts and supervises the server](issues/04-electron-supervises-the-server.md) | ready-for-agent | 02, 03 |
| 05 | [Bundled ffmpeg and the installers](issues/05-bundled-ffmpeg-and-installers.md) | ready-for-agent | 02, 03 |
| 06 | [yt-dlp fetched, cached, and updatable](issues/06-yt-dlp-fetched-and-updatable.md) | ready-for-agent | 02, 04 |
| 07 | [YouTube imports without Node on PATH](issues/07-youtube-without-node-on-path.md) | ready-for-agent | 06 |
| 08 | [Where the library lives, and moving it](issues/08-library-location.md) | ready-for-agent | 04 |
| 09 | [Building, signing, and shipping a release](issues/09-build-sign-and-release.md) | ready-for-agent | 05 |
| 10 | [Drop an audio file on the window](issues/10-drop-to-import.md) | ready-for-agent | 03 |
| 11 | [Docs, ADRs, and the manual pass](issues/11-docs-adrs-and-manual-pass.md) | ready-for-agent | 09 |
