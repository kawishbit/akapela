...
| 04 | [Delete Stems and reclaim disk](issues/04-delete-stems.md) | done | 5/5 | Nothing |
...
| 10 | [Docs, ADRs, and the device pass](issues/10-docs-adrs-device-pass.md) | done | 6/6 | The manual device pass, which needs a human's ears and phone |
