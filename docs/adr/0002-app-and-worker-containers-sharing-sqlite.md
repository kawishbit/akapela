...
## Amendment: one at a time per Lane

"One Job run at a time" becomes one at a time per Lane, with a heavy Lane for Separations and a light Lane for everything else. The SQLite queue itself stands. See ADR 0012.
