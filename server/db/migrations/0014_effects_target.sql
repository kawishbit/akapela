...
CREATE TABLE `__new_tracks` (
	...
	`adjustments` text DEFAULT '{"pitchSemitones":0,"tempoPercent":100,"linked":false,"reverbAmount":0,"lowpassHz":20000,"effectsTarget":"backing"}' NOT NULL,
	`song_artist` text,
	`song_title` text,
...
ALTER TABLE `mixes` ADD `effects_target` text DEFAULT 'backing' NOT NULL;