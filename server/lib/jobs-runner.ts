...
/**
 * `noop` is the only handler until later tickets add `import`, `render`, and
 * `separate` here — each addition is what actually stops the Python worker
 * from being asked to run that Job type.
 */
